            ...
            {!authMethod ? (
              <div className="space-y-3">
                ...
                <button
                  type="button"
                  disabled
                  className="inline-flex h-[2.75rem] w-full items-center justify-center gap-2 rounded-lg border border-[var(--border)] text-[0.9375rem] font-medium text-[var(--text-2)] opacity-60 cursor-not-allowed"
                >
