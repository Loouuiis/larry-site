...
-- 023: Portfolio Gantt schema — categories for projects, parent tasks for subtasks.
...
-- Subcategories, project-scoped categories, project sort order.
-- See: docs/superpowers/specs/2026-04-18-gantt-v4-subcategories-sync-design.md
...
-- Migration 026: project-scoped invitations + shareable invite links (#96).
-- Tenant invites can now atomically land the invitee in a specific project
-- on accept. invite_links powers copy/paste-into-Slack onboarding.
