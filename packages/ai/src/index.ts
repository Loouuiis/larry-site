...
export async function generateBootstrapFromTranscript(
  ...
  const systemPrompt = [
    ...
    "- If the transcript already provides an explicit description for a task, use it verbatim (you may lightly clean formatting). Only write your own description when none is provided.",
